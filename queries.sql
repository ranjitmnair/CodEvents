...
CREATE TABLE `dbms`.`users` ( `User_Id` VARCHAR(25) NOT NULL PRIMARY KEY, `F_Name` VARCHAR(25) NOT NULL , `L_Name` VARCHAR(25) NOT NULL , `password` VARCHAR(25) NOT NULL , `DOB` DATE NOT NULL ) ENGINE = InnoDB;
